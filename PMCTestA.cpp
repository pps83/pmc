...
SCounterDefinition CounterDefinitions[] = {
    ...
    {110, S_P2MC, INTEL_PM, 0, 1, 0, 0xa0, 0,
        "Uops(UF)"}, // unfused microoperations submitted to execution units (Undocumented counter!)
    ...
    {141, S_ID2, PRALL, 0, 1, 0, 0x19, 0x01,
        "FP2I pass"}, // bypass delay to SIMD/int unit from fp unit (These counters cannot be used simultaneously)
    ...
    {201, S_ID2, PRALL, 0, 1, 0, 0xc4, 0x0c,
        "BrTaken"}, // branches taken. (Mask: 1=pred.not taken, 2=mispred not taken, 4=pred.taken, 8=mispred taken)
    ...
    {25, S_ID3, INTEL_7I, 0, 3, 0, 0x79, 0x04,
        "Dec uops"}, // uops from decoders. (MITE = Micro-instruction Translation Engine)
    ...
    {121, S_ID3, INTEL_7, 0, 3, 0, 0xd2, 0x02,
        "Part.reg"}, // Partial register synchronization, clock cycles, Sandy Bridge
    ...
    {201, S_ID3, INTEL_IVY, 0, 1, 0, 0xc4, 0x20,
        "BrTaken"}, // branches taken. (Mask: 1=pred.not taken, 2=mispred not taken, 4=pred.taken, 8=mispred taken)
    ...
    {22, S_ID3, INTEL_HASW, 0, 3, 0, 0x87, 0x01,
        "ILenStal"}, // instruction length decoder stall due to length changing prefix
    {24, S_ID3, INTEL_HASW, 0, 3, 0, 0xA8, 0x01, "Loop uops"}, // uops from loop stream detector
    {25, S_ID3, INTEL_HASW, 0, 3, 0, 0x79, 0x04,
        "Dec uops"}, // uops from decoders. (MITE = Micro-instruction Translation Engine)
    ...
    {201, S_ID3, INTEL_ATOM, 0, 1, 0, 0xc4, 0x0c,
        "BrTaken"}, // branches taken. (Mask: 1=pred.not taken, 2=mispred not taken, 4=pred.taken, 8=mispred taken)
    ...
    {206, S_ID5, INTEL_GOLDM, 0, 3, 0, 0x43, 0x04,
        "MisprSlot"}, // number of issue slots every cycle that were not consumed due to branch misprecidt
    ...
    {106, S_ID3, INTEL_KNIGHT, 0, 1, 0, 0xc2, 0x20,
        "UopVector"}, // uops vector SIMD, except for loads, packed byte and word multiplies
